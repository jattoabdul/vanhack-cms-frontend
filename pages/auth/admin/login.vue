    ...
    <main>
      <div class="auth-wrapper">
        ...
        <p class="sub-text dark-grey-text">
          Enter your login details to access your admin account
        </p>
  ...
  methods: {
    ...
    async login() {
      ...
      try {
        ...
        const { data, status } = await this.$axios.post('/api/auth/admin/login', {
        ...
        if (status === 200) {
          ...
          } = await this.$axios.get('/api/accounts/admin/me', {
            headers: {
